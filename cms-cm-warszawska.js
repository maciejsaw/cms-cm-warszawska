var cmsTexts = {
  ...
  "Promocja! Powiększanie ust - super cena od 600zł",
  
  aktualnoscDrugaData: 
  "Wtorek, 14 lutego 2017",
  
  aktualnoscDrugaTekst: 
  "Zabiegi wykonywane są przez doświadczonego lekarza kosmetologa z 20-letnią praktyką.",
  
  dodatkoweKontaktyAkapitPierwszy:
  "Poza godzinami pracy poradni, bezpłatną opiekę nad naszymi pacjentami przejmuje SPZOZ Wojewódzka Stacja Pogotowia Ratunkowego przy ul. Poleskiej 89  | tel  85 652 67 14",
  
  dodatkoweKontaktyAkapitDrugi:
  "Współpracujemy z Centrum Położnych Środowiskowych Sp.p. Położna środowiskowa Nina Sobiecka: tel 604 564 843",
  
  dodatkoweKontaktyAkapitTrzeci:
  "Informacja medyczne całodobowo | tel. 194 39",
  
  kontaktGodzinyOtwarcia: 
  "PN - PT  w godzinach 8.00 - 18.00",
  
  rodzinnaGodzinyOtwarcia:
  "Poradnia jest czynna od poniedziałku do piątku w godzinach 8.00 - 18.00. Zapisy na wizyty w godz. 8.00- 17.00 telefonicznie, osobiście, za pośrednictwem osób trzecich.",
